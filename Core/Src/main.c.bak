...
__attribute__((section(".myBufSectionEEPROM_V"))) uint16_t eeCntRegEVENT = 0;	//
		...
		/*
		[1]= highByte(10),			//eespdiur_w = 10;			//;t0 - Set point compresor diurno	-3 ° C
		[2]= lowByte(10),			//eespdiur_w = 10;			//
		[3]=0x23,
		[4]=0x24,
		[5]=0x25,
		[6]=0x26,
...
uint8_t numBloqFirm	= 0;	// número de bloques de 128 bytes que componen el firmware
uint8_t cntBloqFirm	= 0;	// contador de bloques de 128 bytes que componen el firmware
